...
func (r *OracleReader) updateStartTime(offsetKeyIndex int, scanArgs []interface{}) bool {
...
func (r *OracleReader) updateTimeCntFromData(v ReadInfo) {
	if r.timestampKeyInt {
...
func (r *OracleReader) trimExistData(datas []ReadInfo) []ReadInfo {
