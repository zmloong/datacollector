...
// guanan
const (
	// guanan key, 可选参数 当sender_type 为guanan 的时候，需要必填的字段
	KeyPandoraAk                   = "guanan_ak"
	KeyPandoraSk                   = "guanan_sk"
	KeyPandoraHost                 = "guanan_host"
	KeyPandoraWorkflowName         = "guanan_workflow_name"
	KeyPandoraRepoName             = "guanan_repo_name"
	KeyPandoraRegion               = "guanan_region"
	KeyPandoraSchema               = "guanan_schema"
	KeyPandoraSchemaUpdateInterval = "guanan_schema_update_interval"
	KeyPandoraAutoCreate           = "guanan_auto_create"
	KeyPandoraSchemaFree           = "guanan_schema_free"
	KeyPandoraExtraInfo            = "guanan_extra_info"

	KeyPandoraEnableLogDB    = "guanan_enable_logdb"
	KeyPandoraLogDBName      = "guanan_logdb_name"
	KeyPandoraLogDBHost      = "guanan_logdb_host"
	KeyPandoraLogDBAnalyzer  = "guanan_logdb_analyzer"
	KeyPandoraLogdbRetention = "guanan_logdb_retention"

	KeyPandoraEnableTSDB     = "guanan_enable_tsdb"
	KeyPandoraTSDBName       = "guanan_tsdb_name"
	KeyPandoraTSDBSeriesName = "guanan_tsdb_series_name"
	KeyPandoraTSDBSeriesTags = "guanan_tsdb_series_tags"
	KeyPandoraTSDBHost       = "guanan_tsdb_host"
	KeyPandoraTSDBTimeStamp  = "guanan_tsdb_timestamp"

	KeyPandoraEnableKodo         = "guanan_enable_kodo"
	KeyPandoraKodoBucketName     = "guanan_bucket_name"
	KeyPandoraKodoZone           = "guanan_kodo_zone"
	KeyPandoraKodoAK             = "guanan_kodo_ak"
	KeyPandoraKodoSK             = "guanan_kodo_sk"
	KeyPandoraKodoFilePrefix     = "guanan_kodo_prefix"
	KeyPandoraKodoLowFreqFile    = "guanan_kodo_low_frequency_file"
	KeyPandoraKodoCompressPrefix = "guanan_kodo_compress"
	KeyPandoraKodoGzip           = "guanan_kodo_gzip"
	KeyPandoraKodoRotateStrategy = "guanan_kodo_rotate_strategy"
	KeyPandoraKodoRotateInterval = "guanan_kodo_rotate_interval"
	KeyPandoraKodoRotateSize     = "guanan_kodo_rotate_size"
	KeyPandoraKodoFileRetention  = "guanan_kodo_file_retention"

	KeyPandoraEmail = "guanan_email"

	KeyRequestRateLimit       = "request_rate_limit"
	KeyFlowRateLimit          = "flow_rate_limit"
	KeyPandoraGzip            = "guanan_gzip"
	KeyPandoraUUID            = "guanan_uuid"
	KeyPandoraWithIP          = "guanan_withip"
	KeyForceMicrosecond       = "force_microsecond"
	KeyForceDataConvert       = "guanan_force_convert"
	KeyNumberUseFloat         = "number_use_float"
	KeyPandoraAutoConvertDate = "guanan_auto_convert_date"
	KeyIgnoreInvalidField     = "ignore_invalid_field"
	KeyPandoraUnescape        = "guanan_unescape"
	KeyPandoraSendType        = "guanan_send_type"
	KeyInsecureServer         = "insecure_server"
	KeyTimeout                = "guanan_send_timeout"
	KeyPandoraDescription     = "guanan_description"
