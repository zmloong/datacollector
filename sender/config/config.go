...
var (
	...
	OptionDatacollectorSendTime = Option{
		KeyName:       KeyDatacollectorSendTime,
		Element:       Radio,
		ChooseOnly:    true,
		ChooseOptions: []interface{}{"true", "false"},
		Default:       "true",
		DefaultNoUse:  false,
		Description:   "添加系统时间(datacollector_send_time)",
		Advance:       true,
...
var ModeKeyOptions = map[string][]Option{
	...
	/*TypePandora: {
		...
		},
		{
			...
			ChooseOnly:   false,
			Default:      "",
			Placeholder:  "datacollector_default_pipeline",
			DefaultNoUse: true,
			Required:     true,
			Description:  "新增或现有的Pipeline名称(guanan_workflow_name)",
		...
		OptionDatacollectorSendTime,
		{
			...
			Default:           NBRegion,
			DefaultNoUse:      false,
			Description:       "创建的资源所在区域(guanan_region)",
			ToolTip:           "工作流资源创建所在区域",
		...
		},
		{
			...
			DefaultNoUse: false,
			Description:  "大数据平台域名(guanan_host)",
			Advance:      true,
		...
		},
		{
			...
			Default:       "true",
			DefaultNoUse:  false,
			Description:   "自动创建实时仓库并更新(guanan_schema_free)",
			Advance:       true,
		...
		},
		{
			...
			Default:      "",
			DefaultNoUse: false,
			Description:  "以DSL语法自动创建实时仓库(guanan_auto_create)",
			Advance:      true,
		...
		},
		{
			...
			Default:      "",
			DefaultNoUse: false,
			Description:  "筛选字段(重命名)发送(guanan_schema)",
			Advance:      true,
		...
		},
		{
			...
			Default:       "true",
			DefaultNoUse:  false,
			Description:   "自动创建并导出到日志分析(guanan_enable_logdb)",
		},
		{
			...
			Default:       "",
			DefaultNoUse:  false,
			Description:   "新增或现有的日志分析仓库名称(guanan_logdb_name)",
			Advance:       true,
			AdvanceDepend: KeyPandoraEnableLogDB,
			ToolTip:       "若不指定使用实时仓库(guanan_repo_name)名称",
		},
		{
			...
			DefaultNoUse:  false,
			Description:   "日志分析域名[私有部署才修改](guanan_logdb_host)",
			Advance:       true,
			AdvanceDepend: KeyPandoraEnableLogDB,
		...
		},
		{
			...
			Default:       "",
			DefaultNoUse:  false,
			Description:   "指定字段分词方式(guanan_logdb_analyzer)",
			Advance:       true,
			AdvanceDepend: KeyPandoraEnableLogDB,
		...
		},
		{
			...
			Default:       "30",
			DefaultNoUse:  false,
			Description:   "指定logdb存储时间(guanan_logdb_retention)",
			Advance:       true,
			AdvanceDepend: KeyPandoraEnableLogDB,
		...
		//	Default:            "false",
		//	DefaultNoUse:       false,
		//	Description:        "自动创建并导出到时序数据库(guanan_enable_tsdb)",
		...
		//	Default:       "",
		//	DefaultNoUse:  false,
		//	Description:   "指定时序数据库仓库名称(guanan_tsdb_name)",
		...
		//	Default:       "",
		//	DefaultNoUse:  false,
		//	Description:   "指定时序数据库序列名称(guanan_tsdb_series_name)",
		//	AdvanceDepend: KeyPandoraEnableTSDB,
		//	ToolTip:       "若不指定使用仓库(guanan_tsdb_name)名称",
		//},
		//{
		...
		//	Default:       "",
		//	DefaultNoUse:  false,
		//	Description:   "指定时序数据库标签(guanan_tsdb_series_tags)",
		//	AdvanceDepend: KeyPandoraEnableTSDB,
		//},
		//{
		...
		//	DefaultNoUse:  false,
		//	Description:   "时序数据库域名[私有部署才修改](guanan_tsdb_host)",
		//	Advance:       true,
		//	AdvanceDepend: KeyPandoraEnableTSDB,
		...
		//	Default:       "",
		//	DefaultNoUse:  false,
		//	Description:   "指定时序数据库时间戳(guanan_tsdb_timestamp)",
		//	Advance:       true,
		//	AdvanceDepend: KeyPandoraEnableTSDB,
		//},
		{
			...
			Default:       "false",
			DefaultNoUse:  false,
			Description:   "自动导出到七牛云存储(guanan_enable_kodo)",
		},
		{
			...
			DefaultNoUse:  true,
			Description:   "云存储仓库名称(启用自动导出到云存储时必填)(guanan_bucket_name)",
		...
		},
		{
			...
			DefaultNoUse:  true,
			Description:   "七牛账户邮箱(guanan_email)",
			AdvanceDepend: KeyPandoraEnableKodo,
		},
		{
			KeyName:       KeyPandoraKodoFilePrefix,
			ChooseOnly:    false,
			Default:       "datacollectorauto/date=$(year)-$(mon)-$(day)/hour=$(hour)/min=$(min)/$(sec)",
			DefaultNoUse:  false,
			Description:   "云存储文件前缀(guanan_kodo_prefix)",
			AdvanceDepend: KeyPandoraEnableKodo,
			Advance:       true,
		},
		{
			...
			Default:       "false",
			DefaultNoUse:  false,
			Description:   "存储为低频文件(guanan_kodo_low_frequency_file)",
			AdvanceDepend: KeyPandoraEnableKodo,
			Advance:       true,
		},
		{
			...
			Default:       "parquet",
			DefaultNoUse:  false,
			Description:   "云存储文件保存格式(guanan_kodo_compress)",
			AdvanceDepend: KeyPandoraEnableKodo,
			Advance:       true,
		},
		{
			...
			Default:       "false",
			DefaultNoUse:  false,
			Description:   "云存储文件压缩存储(guanan_kodo_gzip)",
			AdvanceDepend: KeyPandoraEnableKodo,
			Advance:       true,
		},
		{
			...
			Default:       "interval",
			DefaultNoUse:  false,
			Description:   "云存储文件分割策略(guanan_kodo_rotate_strategy)",
			AdvanceDepend: KeyPandoraEnableKodo,
			Advance:       true,
		},
		{
			...
			Default:       "600",
			DefaultNoUse:  false,
			Description:   "云存储文件分割间隔时间(guanan_kodo_rotate_interval)(单位秒)",
			AdvanceDepend: KeyPandoraEnableKodo,
			Advance:       true,
		},
		{
			...
			Default:       "512000",
			DefaultNoUse:  false,
			Description:   "云存储文件分割文件大小(guanan_kodo_rotate_size)(单位KB)",
			AdvanceDepend: KeyPandoraEnableKodo,
			Advance:       true,
		},
		{
			...
			Default:       "0",
			DefaultNoUse:  false,
			Description:   "云存储文件保存时间(guanan_kodo_file_retention)(单位天,0为永久保存)",
		...
		},
		{
			...
			Default:       "false",
			DefaultNoUse:  false,
			Description:   "数据植入UUID(guanan_uuid)",
			Advance:       true,
		...
		},
		{
			...
			Default:       "false",
			DefaultNoUse:  false,
			Description:   "数据植入来源IP(guanan_withip)",
			Advance:       true,
		},
		OptionFtWriteLimit,
		OptionFtStrategy,
		...
		//},
		{
			...
			Default:       "false",
			DefaultNoUse:  false,
			Description:   "自动转换类型(guanan_force_convert)",
			Advance:       true,
			ToolTip:       `强制类型转换，如定义的guanan schema为long，而实际的为string，则会尝试将string解析为long类型，若无法解析，则忽略该字段内容`,
		},
		{
		...
		},
		{
			...
			Default:       "false",
			DefaultNoUse:  false,
			Description:   "自动转换时间类型(guanan_auto_convert_date)",
			Advance:       true,
		...
		},
		{
			...
			Default:       "true",
			DefaultNoUse:  false,
			Description:   "服务端反转译换行/制表符(guanan_unescape)",
			Advance:       true,
			ToolTip:       `在guanan服务端反转译\\n=>\n, \\t=>\t; 由于guanan数据上传的编码方式会占用\t和\n这两个符号，所以在sdk中打点时会默认把\t转译为\\t，把\n转译为\\n，开启这个选项就是在服务端把这个反转译回来。开启该选项也会转译数据中原有的这些\\t和\\n符号`,
		},
		{
		...
		},
		{
			...
			Default:      "30s",
			DefaultNoUse: false,
			Description:  "发送数据超时时间(guanan_send_timeout)",
			Advance:      true,
			CheckRegex:   "\\d+[hms]",
...
注意，发送之前数据表必须已存在`,
	...
	TypeOpenFalconTransfer: {
		...
		},
		{
			...
			Default:      "",
			DefaultNoUse: false,
			Placeholder:  "datacollector_",
			Description:  "open-falcon transfer metric 前缀(open_falcon_transfer_prefix)，例如datacollector_",
			Advance:      true,
